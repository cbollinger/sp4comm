...
* Week 3 Module 3: 
** Part 1 - Introduction to Fourier Analysis
...
****** Basis vector $\textbf{w}^{(0)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}0 = 0
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
#+results:
[[file:./image/w3_w0.png]]

****** Basis vector $\textbf{w}^{(1)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}1 = \frac{2\pi}{N}
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
#+results:
[[file:./image/w3_w1.png]]

****** Basis vector $\textbf{w}^{(2)} \in \mathbb{C}^{64}$
...
#+results:
[[file:./image/w3_w2.png]]

****** Basis vector $\textbf{w}^{(3)} \in \mathbb{C}^{64}$
...
#+results:
[[file:./image/w3_w3.png]]

****** Basis vector $\textbf{w}^{(4)} \in \mathbb{C}^{64}$
...
****** Basis vector $\textbf{w}^{(5)} \in \mathbb{C}^{64}$
...
****** Basis vector $\textbf{w}^{(16)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}2 = \frac{\pi}{2}
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
#+results:
[[file:./image/w3_w16.png]]

****** Basis vector $\textbf{w}^{(20)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}20
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(21)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}21
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(30)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}30
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(31)} \in \mathbb{C}^{64}$
...
****** Basis vector $\textbf{w}^{(32)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}32 = \frac{2\pi}{64}32 = pi 
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(33)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}33
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(34)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}34
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(60)} \in \mathbb{C}^{64}$
...
****** Basis vector $\textbf{w}^{(62)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}62
  \end{equation*}
  \end{tcolorbox}
#+end_src

So here, for instance, if you compare this basis vector to $\textbf{w}^{(2)}$,
you would see that the real part is the same, but the imaginary part has a sign
inversion.
...
****** Basis vector $\textbf{w}^{(63)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}63
  \end{equation*}
  \end{tcolorbox}
#+end_src
...
****** Basis vector $\textbf{w}^{(64)} \in \mathbb{C}^{64}$

#+begin_src latex
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Fundamental Frequency]
  \begin{equation*}
          \omega = \frac{2\pi}{N}64
  \end{equation*}
  \end{tcolorbox}
#+end_src
